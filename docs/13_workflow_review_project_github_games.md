...
A `github-games` repository will be created for you in the githubschool organization. You can access the repository at `https://github.com/gh-nondevelopers/github-games-USERNAME`.
...
> Remember, your copy of the website will be rendered at `https://gh-nondevelopers.github.io/github-games-USERNAME` once published as a GitHub Page like at [https://gh-nondevelopers.github.io/github-games-jbarbosa26/](https://gh-nondevelopers.github.io/github-games-jbarbosa26/).
>
...
1. Clone your copy of the repository: `git clone https://github.com/gh-nondevelopers/github-games-USERNAME.git`
